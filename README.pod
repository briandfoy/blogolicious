...
Search|http://search.cpan.org/dist/Blogolicious> or
L<MetaCPAN|http://www.metacpan.org/module/Blogolicious>:

=over 4

=item *	L<http://search.cpan.org/dist/Blogolicious>

=item *	L<http://www.metacpan.org/module/Blogolicious>
